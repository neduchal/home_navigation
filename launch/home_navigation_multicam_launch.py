...
def generate_launch_description():
    ...
    realsense_launch = IncludeLaunchDescription(
        launch_description_sources.PythonLaunchDescriptionSource(
            os.path.join(realsense_launch_dir, 'rs_multi_camera_launch.py')),
        launch_arguments={'camera_name1':'camera', 'device_type1': 'd435', 'camera_name2':'camimu', 'device_type2':'t265'}.items()
    )
